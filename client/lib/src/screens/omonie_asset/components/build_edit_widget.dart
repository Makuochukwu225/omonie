...
class BuildEditWidget extends StatefulWidget {
  final Asset data;
  const BuildEditWidget({
    Key? key,
    required this.data,
  }) : super(key: key);

  @override
  State<BuildEditWidget> createState() => _BuildEditWidgetState();
}

class _BuildEditWidgetState extends State<BuildEditWidget> {
  ...
  void initState() {
    ...
    value.text = widget.data.value!.toString();
                      ...
                      children: [
                        ...
                        Expanded(
                          child: page == 1
                              ...
                              : AppButton(
                                  onPressed: () {
                                    data.addAll({"id": widget.data.id});

                                    data.addAll(
                                        {"image": image ?? widget.data.image});
